...
class Cedcoss_Inxpress_Block_Adminhtml_Dhl_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
  ...
  protected function _beforeToHtml()
  {
      $this->addTab('general', array(
          ...
          'content'   => $this->getLayout()->createBlock('inxpress/adminhtml_dhl_edit_tab_general')->toHtml(),
      ));
