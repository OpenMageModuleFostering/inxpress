 ...
 */
class Cedcoss_Inxpress_Block_Adminhtml_Catalog_Product_Edit_Tab_Variant
  ...
  
{
    ...
    public function __construct()
    {
        ...
        $this->setTemplate('inxpress/productedit.phtml');
    }
    ...
    protected function _prepareLayout()
    {
        $button = $this->getLayout()->createBlock('adminhtml/widget_button')
            ->setData(array(
                'label' => Mage::helper('catalog')->__('Add Custom'),
                'onclick' => 'return customControl.addItem();',
                'class' => 'add'
            ));
        $button->setName('add_custom_item_button');
