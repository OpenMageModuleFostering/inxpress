...
class Cedcoss_Inxpress_Block_Adminhtml_Catalog_Product_Edit_Tab_Attributes extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Attributes
{
    /**
    ...
    protected function _prepareForm()
    {
        ...
        if ($group) {
			...
			if($group->getAttribute_group_name()=='General')
			{	
				
				 $variantAttribute = $form->getElement('inxpress_variant');
				if ($variantAttribute) {
				
					$variantAttribute->setRenderer(
						$this->getLayout()->createBlock('inxpress/adminhtml_catalog_product_edit_tab_variant')
					);
				}
			}
			 $customAttribute = $form->getElement('custom_attribute');
            if ($customAttribute) {
                $customAttribute->setRenderer(
                    $this->getLayout()->createBlock('adminhtml/catalog_product_edit_tab_custom')
                );
            }
